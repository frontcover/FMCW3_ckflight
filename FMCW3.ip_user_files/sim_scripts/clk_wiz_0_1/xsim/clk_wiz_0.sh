...
#
# Script generated by Vivado on Fri Oct 24 13:18:22 +0300 2025
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_87ec.protoinst" -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
